...
--
-- Host: localhost
-- Generation Time: 23-Nov-2016 às 16:36
...
INSERT INTO `tcc_lotes` (`id_lotes`, `dataIniciada`, `dataFinalizada`, `ativa`, `quantidade`, `id_produto`) VALUES
(1, '2016-11-22', NULL, 'S', 10, 2),
(2, '2016-11-25', NULL, 'S', 10, 2);
...
INSERT INTO `tcc_produtos` (`id_produto`, `nome`, `preco`, `fotoProduto`, `id_modelo`, `material`, `id_cor`, `categoria`, `tipoProduto`, `personalizado`, `peso`, `descricao`, `id_tamanho`) VALUES
(1, 'Camiseta', 40, 'produtos/17-11-2016 0108/img7.png', NULL, 'Algodão', 1, 'Dia dos Pais', NULL, 'N', 0.1, 'Camiseta Vermelha Algodão', NULL),
(2, 'Nippes', 20, 'produtos/17-11-2016 0108/img7.png', 1, '100% algodão', 1, 'Verão', NULL, 'N', 0.05, 'Nippes ', NULL),
(3, 'testando', 25, 'produtos/17-11-2016 0108/img7.png', NULL, NULL, 1, NULL, 'Camiseta', 'N', NULL, 'Camiseta2', NULL),
(4, 'Camiseta3', 30, 'produtos/17-11-2016 0108/img7.png', NULL, NULL, 1, NULL, 'Camiseta', 'N', NULL, 'Camiseta3', NULL),
(5, 'Polo', 20, 'produtos/22-11-2016 1821/polo.png', 1, NULL, 1, NULL, 'Camiseta', 'M', NULL, '', 1),
(6, 'Polo', 20, 'produtos/22-11-2016 1821/polo.png', NULL, NULL, 1, NULL, NULL, 'M', NULL, '', 2),
(7, 'Polo', NULL, 'produtos/22-11-2016 1821/polo.png', NULL, NULL, 1, NULL, NULL, '', NULL, '', 4),
(8, 'Lisa', 20, NULL, 1, NULL, 1, NULL, 'Camiseta', 'M', NULL, '', 2),
(9, 'Polo', 20, NULL, 1, NULL, 2, NULL, NULL, 'M', NULL, '', 5),
(10, 'Polo', 20, NULL, NULL, NULL, 1, NULL, NULL, 'M', NULL, '', 5);
...
ALTER TABLE `tcc_lotes`
  ...
  ADD KEY `FK_idProdutos_lotes` (`id_produto`);
...
--
ALTER TABLE `tcc_cor`
  MODIFY `id_cor` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- Limitadores para a tabela `tcc_lotes`
--
ALTER TABLE `tcc_lotes`
  ADD CONSTRAINT `FK_idProdutos_lotes` FOREIGN KEY (`id_produto`) REFERENCES `tcc_produtos` (`id_produto`);
